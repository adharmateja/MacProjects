...
- (id)initWithFrame:(NSRect)frame
{
    ...
    bgColor = [NSColor whiteColor];//[NSColor colorWithCalibratedRed: 0.6 green:0.6 blue:0.6 alpha:1.0];
    tabBGColor = [NSColor whiteColor];//[NSColor colorWithCalibratedRed: 0.68 green: 0.68 blue: 0.68 alpha:1.0];
        tabActivedBGColor = [NSColor whiteColor];
        tabBorderColor = [NSColor blueColor];//[NSColor colorWithCalibratedRed: 0.53 green:0.53 blue:0.53 alpha:1.0];
        tabTitleColor = [NSColor blueColor];
        tabActivedTitleColor = [NSColor blueColor];
    smallControlColor =[NSColor blueColor];// [NSColor colorWithCalibratedRed:0.53 green:0.53 blue:0.53 alpha:1.0];
